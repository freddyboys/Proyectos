...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="CCFF99" 
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation" 
        ...
        <tr>
          <td width="165">&nbsp;
            <div align="center"><br />
              &nbsp;<br />
          <span class="Estilo3">CATALOGO</div></td>
        </tr>
        <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="336">
        <tr>
          <td width="336" class="pageName"><p>CONTACTO</p>
          <p class="Estilo5">Informaci&oacute;n de contacto</p>
            ...
            <table role="presentation">
                  ...
                  <td><ul>
                    <li>
                      <table cellspacing="0" cellpadding="0">
                        <tbody>
                          <tr>
                            <td><span dir="ltr">098 549 840</span></td>
                          </tr>
                        </tbody>
                      </table>
                    </li>
              ...
              <tbody>
                <tr>
                  ...
                  <td><ul>
                    <li>Imbabura N1-79 y Bol&iacute;var</li>
                    <li>Quito, Ecuador</li>
                  </ul></td>
                </tr>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td><ul>
                    <li><a  rel="">joyeria.amistad@facebook.com</a></li>
                  </ul></td>
                </tr>
              </tbody>
            </table>
    ...
    <td width="50"><img src="images/mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="190">
			...
			<p>
			  ...
			  ESMERALDA
			  <br />
			<a href="ESMERALDA.jsp">Read more &gt;</a></p>
			�<br />
			&nbsp;<br />
			&nbsp;<br />			</td>
			<td width="40">&nbsp;</td>
