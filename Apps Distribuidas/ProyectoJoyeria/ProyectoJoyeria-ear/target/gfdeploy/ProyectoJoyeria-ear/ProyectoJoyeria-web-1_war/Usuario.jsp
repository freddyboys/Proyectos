...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#CCFF99">
        <form method="post" name="forma" action="Validacion.jsp">
                ...
                <tr>
                    <td width="165" valign="top" bgcolor="#E6F3FF">
                        <table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation" 
                            ...
                            <tr>
                                <td width="165"><a href="AROS.jsp" class="navText">AROS DE MATRIMONIO </a></td>
                            </tr>
                            <tr>
                                <td width="165">&nbsp;</td>
                            </tr>
                            <tr>
                                <td width="165"><a href="JOYASDEPLATA.jsp" class="navText">JOYAS DE PLATA </a></td>
                            </tr>
                            <tr>
                                <td width="165">&nbsp;</td>
                            </tr>
                    ...
                    <td colspan="2" valign="top"><img src="images/mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
                                ...
                                <table >
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="submit" name="aceptar" value="Aceptar" /></td>
                                    </tr>
                                    
                                </table>
                                    <label>
                                        <input type="button" name="registrarse" value="REGISTRARSE" onclick="window.location = 'AGREGARUSUARIO.jsp';">
                                    </label>
                            </form>
                            <br />
                            <br />
