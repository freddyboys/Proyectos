...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="CCFF99">
 ...
 <tr>
    ...
    <br />	  
        ...
        <br />
        <span class="hasCaption">De color 
        traslucido, rosado, amarillento,azul, verde o gris. Proporciona una apertura 
        mental y una conexiòn fìsica, que permite el aprovechamiento integral de la 
        capacidad de las fuerzas del inconsciente.<br />
        El diamante es carbono puro que se cristaliza en el sistema cúblico con la más 
        alta dureza que se conoce. Es incoloro o tenúamente coloreado, las variantes 
        transparentes son las gemas más valoradas.<br />
        <br />
        Es la piedra más costosa y la de mayor calidad. Símbolo del amor eterno, quizá 
        por ser tan difícil de hallar y de obtener, se caracterizan por su dureza y 
        belleza.</span><span id="fbPhotoSnowliftTagList" class="fbPhotoTagList"><span 
            class="fcg"></span></span><br />
        <br />
        <br />
        <br />
&nbsp;<br />
