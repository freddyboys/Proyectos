...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="CCFF99">
 ...
 <tr>
    ...
    <p>INGRESE CONTRASE&Ntilde;A: 
      <label>
          <input type="password" name="clave" />
      </label>
    </p>
    <p>CONFIRMACION DE LA CONTRASE&Ntilde;A: 
      <label>
    ...
    <p>INGRESE TELEFONO: <label>
    <input type="text" name="telefono" />
    </label>
	</p>
    
    <p>INGRESE TIPO DE USUARIO:  
      <label>
    ...
    <td width="50"><img src="imagenes/images/mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
        <td width="190" valign="top"><br />
		&nbsp;<br />
		<table border="0" cellspacing="0" cellpadding="0" width="190">
			<tr>
                            <td colspan="3" class="subHeader" align="center"></td></tr>

			<tr>
			<td width="40">&nbsp;</td>
			<td width="110" id="Td1" class="smallText">&nbsp;</td>
			<td width="40">&nbsp;</td>
			</tr>
		</table>	</td>
	<td width="123">&nbsp;</td>
...
&nbsp;<br />
    ...
    <td><img src="images/mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
