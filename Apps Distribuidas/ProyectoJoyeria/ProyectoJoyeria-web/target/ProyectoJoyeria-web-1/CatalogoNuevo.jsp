...
<body bgcolor="#CCFF99">
    <form name="forma" action="CatalogoCreacion.jsp" method="post">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation" 
       ...
       <tr>
        ...
        <tr>
          <td width="165"><a href="AROS.aspx">AROS DE MATRIMONIO </a></td>
        </tr>
        <tr>
          <td width="165">&nbsp;</td>
        </tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="305">
        <tr>
          <td class="pageName">CREAR CATALOGO<br />
            </td>
		</tr>
            ...
            <tr>
                ...
                <td><input type='button' name="cancelar" value="cancelar" onclick="window.location = 'AdministracionCatalogo.jsp';" /></td>
            </tr>
        </table>
