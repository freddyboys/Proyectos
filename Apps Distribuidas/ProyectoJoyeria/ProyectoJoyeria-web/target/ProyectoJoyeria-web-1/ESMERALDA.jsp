...
<table border="0" cellpadding="0" cellspacing="0" bgcolor="CCFF99">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="305">
        <tr>
          <td class="pageName">ESMERALDA</td>
		</tr>
    ...
    <br />	  
        ...
        <br />
        <span class="hasCaption">Es una 
        variedad de berilo de color verde. Su coloración se debe a las impurezas de 
        óxido de cromo. Cuando es totalmente transparente y no presenta deformaciones, 
        constituye una gema muy valorada. Se la considera símbolo de amor, felicidad o 
        fidelidad.</span><span id="fbPhotoSnowliftTagList" 
            class="fbPhotoTagList"><span class="fcg"></span></span><br />
        <br />
        <br />
&nbsp;<br />
        <br />
